    ...
    return (
        ...
        >
            <DIV>
                ...
                <div>
                    <Item>
                        <img alt="" src={'/images/recruit/mod.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
                    ...
                    <Item>
                        <img alt="" src={'/images/recruit/program.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
                ...
                <div>
                    <Item>
                        <img alt="" src={'/images/recruit/hassou.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
                    ...
                    <Item>
                        <img alt="" src={'/images/recruit/design.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
                ...
                <div>
                    <Item>
                        <img alt="" src={'/images/recruit/en.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
                    ...
                    <Item>
                        <img alt="" src={'/images/recruit/alpha.png'} width={150} height={150} />
                        <ul style={{
                            fontSize: `15px`,
                            color: `#000`
                        }}>
